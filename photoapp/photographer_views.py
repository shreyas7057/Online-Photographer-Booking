# here all the views which are required in the panel/dashboard of photographer like, adding there own information, add image gallery, adding stats etc.
...
# this view is for the logged in photographer. when photographer logs in then it sees the total bookings and todays booking
...
# adding the information of the new photographer
@login_required(login_url='login-user')
...
# view the photograher information in admin panel
@login_required(login_url='login-user')
...
# adding the stat information of logged in photographer
@login_required(login_url='login-user')
